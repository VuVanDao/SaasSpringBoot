...
public class InventoryItemController {
    ...
    public ApiResponse AddProductsToInventory(
    ...
    public ApiResponse<List<InventoryItemProduct>> getProductsInInventory(
            @PathVariable Long inventoryId,
            @RequestHeader("${app.header-tenant}") Long tenantId) {
    ...
    public ApiResponse<List<InventoryItemInventory>> getInventoriesByProductId(
            @PathVariable Long productId,
            @RequestHeader("${app.header-tenant}") Long tenantId) {
